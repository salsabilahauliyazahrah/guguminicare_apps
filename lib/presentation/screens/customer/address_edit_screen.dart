// lib/presentation/screens/profile/edit_address_screen.dart
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:tugas_akhir/core/theme/app_colors.dart';
import 'package:tugas_akhir/core/models/address_model.dart'; // IMPORT MODEL

class EditAddressScreen extends StatefulWidget {
  final AddressModel addressData; // <-- UBAH KE AddressModel
...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    _namaAlamatController.text = widget.addressData.jenis_alamat;
    _alamatLengkapController.text = widget.addressData.alamat_lengkap;
    _kotaController.text = widget.addressData.kota;
    _kodePosController.text = widget.addressData.kode_pos;
    _catatanController.text = widget.addressData.catatan;
    _selectedJenis = widget.addressData.jenis_alamat;
    
    // PERBAIKAN DI SINI: Gunakan getter isUtamaBool
    _isUtama = widget.addressData.isUtamaBool;
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              // Checkbox Jadikan Alamat Utama (hanya jika belum utama)
              if (!_isUtama) _buildUtamaCheckbox(),
  ...
  void _updateAddress() {
    if (_formKey.currentState!.validate()) {
      // Buat AddressModel yang diperbarui menggunakan copyWith
      final updatedAddress = widget.addressData.copyWith(        
        alamat_lengkap: _alamatLengkapController.text,
        kota: _kotaController.text,
        kode_pos: _kodePosController.text,
        catatan: _catatanController.text,
        jenis_alamat: _selectedJenis,
        is_utama: _isUtama.toString(),
      );
      
      // Kembali ke halaman sebelumnya dengan AddressModel yang diperbarui
